...
public class EquippableItemProperties extends ItemProperties {
    ...
    public EquippableItemProperties(ObjectType type, int id, String name, int graphic, int value, List<UserArchetype> forbiddenArchetypes, List<Race> forbiddenRaces,
