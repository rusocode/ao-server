...
import com.ao.config.yaml.IntervalsConfigYaml;
...
public class BootstrapModule extends AbstractModule {
    ...
    protected void configure() {
        // Binds ServerConfig implementation to ServerConfigIni as a singleton (unique
        // instance), this telling Guice: "When someone asks for ServerConfig, give him
        // ServerConfigIni"
        bind(ServerConfig.class).to(ServerConfigIni.class).in(Singleton.class);
        // Another incarnation of this mechanism is the named binding that binds the
