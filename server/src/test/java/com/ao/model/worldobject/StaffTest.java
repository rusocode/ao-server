...
public class StaffTest extends WeaponTest {
    ...
    public void setUp() throws Exception {
        final StaffProperties props1 = new StaffProperties(WorldObjectType.MELEE_WEAPON, 1, "Walnut Rod", 1, 1, 0, null, null, false, false, false, false, 1, true, PIERCING_DAMAGE, MIN_HIT, MAX_HIT, MAGIC_POWER, DAMAGE_BONUS);
        weapon1 = new Staff(props1, 5);

        final StaffProperties props2 = new StaffProperties(WorldObjectType.MELEE_WEAPON, 1, "Plum Rod", 1, 1, 0, null, null, false, false, false, false, 1, false, PIERCING_DAMAGE, MAX_HIT, MAX_HIT, MAGIC_POWER, DAMAGE_BONUS);
