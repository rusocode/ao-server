...
public class ArmorTest extends AbstractDefensiveItemTest {
    ...
    public void setUp() throws Exception {
        DefensiveItemProperties props1 = new DefensiveItemProperties(ObjectType.ARMOR, 1, "Leather Armor", 1, 1, 0, null, null, false, false, false, false, 1, MIN_DEF, MAX_DEF, MIN_MAGIC_DEF, MAX_MAGIC_DEF);
        armor1 = new Armor(props1, 5);

        DefensiveItemProperties props2 = new DefensiveItemProperties(ObjectType.ARMOR, 1, "Leather Armor", 1, 1, 0, null, null, false, false, false, false, 1, MAX_DEF, MAX_DEF, MAX_MAGIC_DEF, MAX_MAGIC_DEF);
