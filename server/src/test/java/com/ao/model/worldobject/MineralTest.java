...
public class MineralTest extends AbstractItemTest {
    ...
    public void setUp() throws Exception {
        ItemProperties props1 = new ItemProperties(ObjectType.MINERAL, 1, "Gold", 1, 1, null, null, false, false, false, false);
        mineral1 = new Mineral(props1, 1);

        ItemProperties props2 = new ItemProperties(ObjectType.MINERAL, 1, "Cooper", 1, 1, null, null, false, false, false, false);
