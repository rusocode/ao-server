...
public class WoodTest extends AbstractItemTest {
    ...
    public void setUp() throws Exception {
        WoodProperties props1 = new WoodProperties(ObjectType.WOOD, 1, "Black Potion", 1, 1, null, null, false, false, false, false, WoodType.NORMAL);
        wood1 = new Wood(props1, 5);

        WoodProperties props2 = new WoodProperties(ObjectType.WOOD, 1, "Black Potion", 1, 1, null, null, false, false, false, false, WoodType.ELVEN);
