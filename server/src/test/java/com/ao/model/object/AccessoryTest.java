...
public class AccessoryTest extends AbstractDefensiveItemTest {
    ...
    public void setUp() throws Exception {
        DefensiveItemProperties props1 = new DefensiveItemProperties(ObjectType.ACCESSORY, 1, "Gold Ring", 1, 1, 0, null, null, false, false, false, false, 1, MIN_DEF, MAX_DEF, MIN_MAGIC_DEF, MAX_MAGIC_DEF);
        accessory1 = new Accessory(props1, 5);

        DefensiveItemProperties props2 = new DefensiveItemProperties(ObjectType.ACCESSORY, 1, "Diamond Ring", 1, 1, 0, null, null, false, false, false, false, 1, MAX_DEF, MAX_DEF, MAX_MAGIC_DEF, MAX_MAGIC_DEF);
    ...
    public void testClone() {
        ...
        Accessory clone2 = (Accessory) accessory2.clone();
