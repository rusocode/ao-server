...
public class GrabablePropTest extends AbstractItemTest {
    ...
    public void setUp() throws Exception {
        ItemProperties props1 = new ItemProperties(ObjectType.GRABABLE_PROP, 1, "Black Potion", 1, 1, null, null, false, true, false, true);
        prop1 = new GrabableProp(props1, 5);

        ItemProperties props2 = new ItemProperties(ObjectType.GRABABLE_PROP, 1, "Black Potion", 1, 1, null, null, false, false, false, true);
