...
public class StrengthPotionTest extends AbstractItemTest {
    ...
    public void setUp() throws Exception {
        TemporalStatModifyingItemProperties props1 = new TemporalStatModifyingItemProperties(ObjectType.STRENGTH_POTION, 1, "Green Potion", 1, 1, null, null, false, false, false, false, MIN_STR, MAX_STR, DURATION);
        potion1 = new StrengthPotion(props1, 5);

        TemporalStatModifyingItemProperties props2 = new TemporalStatModifyingItemProperties(ObjectType.STRENGTH_POTION, 1, "Big Green Potion", 1, 1, null, null, false, false, false, false, MAX_STR, MAX_STR, DURATION);
